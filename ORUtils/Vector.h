...
namespace ORUtils {
	...
	public:
		...
		// Initialisation
		////////////////////////////////////////////////////////////////////////////////
		_CPU_AND_GPU_CODE_ static Vector2<T> Zero(void){
	...
	public:
		...
		// Initialisation
		////////////////////////////////////////////////////////////////////////////////
		_CPU_AND_GPU_CODE_ static Vector3<T> Zero(void){
	...
	public:
		...
		// Initialisation
		////////////////////////////////////////////////////////////////////////////////
		_CPU_AND_GPU_CODE_ static Vector4<T> Zero(void){
	...
	public:
		...
		// Initialisation
		////////////////////////////////////////////////////////////////////////////////
		_CPU_AND_GPU_CODE_ static Vector6<T> Zero(void){
			return Vector6<T>((T)0, (T)0, (T)0, (T)0, (T)0, (T)0);
		}
	};
	...
	public:
		...
		// Initialisation
		////////////////////////////////////////////////////////////////////////////////
		_CPU_AND_GPU_CODE_ static VectorX<T,s> Zero(void){
			VectorX<T,s> out;
			for (int i = 0; i < s; i++) out[i] = (T)0;
			return out;
		}
	};
